...
**R** is a calculator, among other things. It does what you'd expect. 
...
Here we've indexed by number, but you can do it by element name as well, shown below.
