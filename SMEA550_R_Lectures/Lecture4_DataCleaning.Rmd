---
title: 'Lecture X: Data-Cleaning and Workplace Management'
...
strsplit(OA_Samples$Sample, "_") 

```
But, the output is a list with a variable number of elements. And wehat I had in mind is to create three new columns in the same dataframe, named Site,  Date, and Replicate.
...
separate(data = OA_Samples,# From the dataframe OA_Sampes
         col = Sample, # Separate the column Sample
