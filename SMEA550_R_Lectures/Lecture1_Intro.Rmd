...
* Functions  do something to an object to create some kind of output. (Functions require *arguments* to tell them what to do... often, these arguments will include an object on which to act, as well as some options).  The syntax is as follows: ``function_name(arguments)``, which tells **R** use the function ``function_name`` and apply it to these arguments.
